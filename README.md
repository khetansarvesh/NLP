...
[Here in this colab notebook by Unsloth](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Qwen3_(4B)-GRPO.ipynb#scrollTo=1pGRMY2m6aiu) we have finetuned a non reasoning model to a reasoning model using GRPO technique in RL.
